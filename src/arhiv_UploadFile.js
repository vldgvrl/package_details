import React from 'react';
  ...
  function UploadFile(){
    return(
        <div>
            <div id="input_file">
                <p>Choose the status file,<br/> pressing this button: </p>
                <input type="file" id="file_input" onChange={readStatusFile} />
            </div>
            <div>
        </div>
    );
  ...
  console.log("Function run");
    ...
    if (f) {
	  ...
	  for (var i=0; i<packageList.length; i++){
	      ...
	      elem.insertAdjacentHTML("beforeend", "<li><a onclick='showDetails(" + i + ")' href='#'>" + packageLine[0] + "</a></li>");
  ...
  //=====End open function=====
    ...
    console.log("Find all dependencies function");
